...
worksheet = gc.open_by_key('1ay-aVVeGWZOeiin6VrQ_sPsQCa4sRZHklRG91bNXXi8').sheet1
...
def certificate_generate(name_list,name,final_action,start,end):
...
for items in range(0,len(name)):
    cert_list.append(certificate_generate(name_list,name[items],action_final[items],start,end))
...
spreadsheet_id = '1ay-aVVeGWZOeiin6VrQ_sPsQCa4sRZHklRG91bNXXi8'
